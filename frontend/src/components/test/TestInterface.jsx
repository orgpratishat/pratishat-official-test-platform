...
//             timeSpentData: formatted // Pass detailed time data
//           } 
//         });
...
//   // 🎯 FIXED: Auto-submit with proper response capture
//   const handleAutoSubmit = async () => {
//     if (timeUp) return;
...
//       console.log('📤 [SUBMIT_FORMATTED] Formatted responses:', formatted);
...
//       console.log('📤 [SUBMIT_PAYLOAD] Final payload:', payload);
...
//   const handleSubmit = async () => {
//     await submitTest(); // This uses the current state
//   };
...
//                   responses: responses,
//                   refCount: Object.keys(responsesRef.current).length
//                 });
//               }}
