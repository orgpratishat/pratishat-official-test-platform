...
//     keys: ['questionText'], threshold: 0.3, ignoreLocation: true
//   }), [questions]);
...
//             <div className="text-xs text-gray-500">Difficulty: 
//               <Badge 
//                 variant={
...
//             >
//               <RotateCcw className="w-4 h-4 bg-red-400" />
//               Change Answer
//             </Button>
//           </div>
//         )}
...
//         <div className="space-y-6 mb-6 bg-red-400">
//           {/* Result Banner */}
...
//               </div>
//               <p className="text-yellow-700 leading-relaxed">{current.hint.text}</p>
//               {current.hint.image && (
...
//               </div>
//               <p className="text-blue-700 leading-relaxed">{current.approach.text}</p>
...
//                     </div>
//                     <div className="flex-1">
//                       <p className="text-purple-700 mb-2">{step.stepText}</p>
//                       {step.stepImage && (
...
// Function to format text with HTML tags for display
