...
//     keys: ['questionText','subject','chapter','topic','exam'], // Added exam to search keys
...
//                 {['subject', 'chapter', 'topic', 'difficulty', 'exam', 'year'].map((field) => (
//                   <div key={field}>
//                     <label className="block text-sm font-medium mb-2 text-gray-700">
//                       {field.charAt(0).toUpperCase() + field.slice(1)}
//                     </label>
//                     {(field === 'subject' || field === 'difficulty') ? (
//                       <select
//                         required
//                         value={(newMode ? newData : formData)[field]}
//                         onChange={e => {
//                           const setter = newMode ? setNewData : setFormData;
...
//                         onChange={e => {
//                           const setter = newMode ? setNewData : setFormData;
//                           setter(prev => ({ ...prev, [field]: parseInt(e.target.value) }));
//                         }}
