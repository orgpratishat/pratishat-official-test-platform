...
export const getSubjectChapters = async (subject) => {
  const response = await api.get(`${API_BASE}/subjects/${subject}/chapters`);
  return response;
};

export const getChapterDPPs = async (subject, chapter) => {
  const response = await api.get(`${API_BASE}/subjects/${subject}/chapters/${chapter}/dpps`);
  return response;
};
...
export const createDPP = async (dppData) => {
  const response = await api.post(API_BASE, dppData);
  return response;
};
...
export const updateDPP = async (id, dppData) => {
  const response = await api.put(`${API_BASE}/${id}`, dppData);
  return response;
};
